            ...
            <div class="content-primary" id="DataEntry">
               <ul data-role="listview"  id="DataEntryList" data-icon="arrow-r" data-inset="true" >
                  ...
                  <li data-icon="gear">
                     ...
                     <h4 class="ui-li-heading">More than 8 fast days in past month</h4></a>
                  ...
                  <li data-icon="gear">
                     ...
                     <h4 class="ui-li-heading">Between 7 and 8 fast days in past month</h4></a>
                     <a href="#pageUpdateGASLevel" data-ajax="false"></a>
                  </li>

                  <li data-icon="gear">
                     <a><img src="images/gas/level/expected.png"  class="ui-li-thumb ui-corner-none" title="Expected Outcome" alt="Expected Outcome"> 
                     <h4 class="ui-li-heading">Between 5 and 6 fast days in past month</h4></a>
                     <a href="#pageUpdateGASLevel" data-ajax="false"></a>
                  </li>
                  ...
                  <li data-icon="gear">
                     ...
                     <h4 class="ui-li-heading">Between 3 and 4 fast day in past month</h4></a>
                     <a href="#pageUpdateGASLevel" data-ajax="false"></a>
                  </li>
                  ...
                  <li data-icon="gear">
                     ...
                     <h4 class="ui-li-heading">Less than 2 fast days in past month</h4></a>
                     <a href="#pageUpdateGASLevel" data-ajax="false"></a>
                  </li>
