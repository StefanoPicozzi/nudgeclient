            ...
            <div class="content-primary" id="DataEntry">
               <ul data-role="listview"  id="DataEntryList" data-icon="arrow-r" data-inset="true" >
                  ...
                  <li data-icon="gear">
                     ...
                     <h4 class="ui-li-heading">More than 20 days over 10K steps in past month</h4></a>
                  ...
                  <li data-icon="gear">
                     ...
                     <h4 class="ui-li-heading">Between 17 and 19 days over 10K steps in past month</h4></a>
                     <a href="#pageUpdateGASLevel" data-ajax="false"></a>
                  </li>

                  <li data-icon="gear">
                     <a><img src="images/gas/level/expected.png"  class="ui-li-thumb ui-corner-none" title="Expected Outcome" alt="Expected Outcome"> 
                     <h4 class="ui-li-heading">Between 12 and 16 days over 10K steps in past month</h4></a>
                     <a href="#pageUpdateGASLevel" data-ajax="false"></a>
                  </li>
                  ...
                  <li data-icon="gear">
                     ...
                     <h4 class="ui-li-heading">Between 9 and 11 days over 10K steps in past month</h4></a>
                     <a href="#pageUpdateGASLevel" data-ajax="false"></a>
                  </li>
                  ...
                  <li data-icon="gear">
                     ...
                     <h4 class="ui-li-heading">Less than 8 days over 10K steps in past month</h4></a>
                     <a href="#pageUpdateGASLevel" data-ajax="false"></a>
                  </li>
