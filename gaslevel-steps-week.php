            ...
            <div class="content-primary" id="DataEntry">
               <ul data-role="listview"  id="DataEntryList" data-icon="arrow-r" data-inset="true" >
                  ...
                  <li data-icon="gear">
                     ...
                     <h4 class="ui-li-heading">6+ days over 10K steps in past week</h4></a>
                  ...
                  <li data-icon="gear">
                     ...
                     <h4 class="ui-li-heading">5 days over 10K steps in past week</h4></a>
                     <a href="#pageUpdateGASLevel" data-ajax="false"></a>
                  </li>

                  <li data-icon="gear">
                     <a><img src="images/gas/level/expected.png"  class="ui-li-thumb ui-corner-none" title="Expected Outcome" alt="Expected Outcome"> 
                     <h4 class="ui-li-heading">4 days over 10K steps in past week</h4></a>
                     <a href="#pageUpdateGASLevel" data-ajax="false"></a>
                  </li>
                  ...
                  <li data-icon="gear">
                     ...
                     <h4 class="ui-li-heading">3 days over 10K steps in past week</h4></a>
                     <a href="#pageUpdateGASLevel" data-ajax="false"></a>
                  </li>
