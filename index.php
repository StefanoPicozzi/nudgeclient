            ...
            <div data-role="content">
               <div class="content-primary" id="Home">
                  <ul  data-role="listview" id="HomeList" data-inset="true" data-icon="arrow-r">
                     ...
                     <?php if ( isset($_SESSION['roletype']) && $_SESSION['roletype'] == "architect" ) { ?>
                     <li>
         ...
         <div data-role="content">
            <div class="content-primary" id="DataEntry">
               <ul data-role="listview"  id="DataEntryList" data-icon="arrow-r" data-inset="true" >
                  ...
                  <li>
                     <a href="userdiary.php" data-ajax="false">
                     <img src="images/diary.png" title="Diary" alt="Diary" class="ui-li-thumb"> 
                     <h4 class="ui-li-heading">Diary</h4></a>
                  </li>
                  <li>
                     <a href="userobs.php" data-ajax="false">
                     <img src="images/obs.png" alt="Observation" class="ui-li-thumb"> 
                      <h4 class="ui-li-heading">Observations</h4> </a>
                  </li>
               </ul>
            </div>
         </div>
...
$('#pageHome').on('pagebeforeshow', function(event) {
   ...
   $('.welcome').empty();         
   if (programname != null) {
      $('.welcome').append("Home Menu - " + programname + "" );
   } else {
