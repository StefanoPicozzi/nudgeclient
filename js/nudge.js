...
obstypeJSON[1] = {
   "name" : "medication",
   "metric" : "Take prescribed medication"
};
obstypeJSON[2] = {
   "name" : "meditation",
...
function writeHeader (left, right) {
   ...
   if (left == "backrulefile") { leftlink = "#pagerulefile";                 lefticon = "back";  }  
   if (left == "backdonudge")  { leftlink = "donudge.php";                   lefticon = "back";  }  
   if (left == "backgashigh")  { leftlink = "gashigh.php";                   lefticon = "back";  }  
   if (left == "backgaslow")   { leftlink = "gaslow.php";                    lefticon = "back";  }  
   if (left == "backgaslevel") { leftlink = "gaslevel.php";                  lefticon = "back";  }  
