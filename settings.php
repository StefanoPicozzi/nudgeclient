   ...
   <div data-role="content">
      <div class="content-primary" id="Settings">
         <ul data-role="listview"  id="SettingsList" data-icon="arrow-r" data-inset="true" >
            ...
            <li>
               <a href="gashigh.php" data-ajax="false" >Behavioural Goals</a>
            </li>

            <li>
               <a href="gashigh-target.php" data-ajax="false" >Target Goals</a>
            </li>
            ...
            <?php if ( $_SESSION['roletype'] == "architect") { ?>             
               <li> <a href="rulefile.php?roletype=architect" data-ajax="false">Rule Files</a> </li>
            <?php } ?>

            <?php if ( $_SESSION['roletype'] == "architect") { ?>    
               <li> <a href="NudgeAPI.php?roletype=architect" data-ajax="false">API</a> </li>
            <?php } ?>

            <?php if ( $_SESSION['userid'] == "99") { ?>                
               <li> <a href="donudge.php" data-ajax="false"> Nudge</a> </li>
            <?php } ?>
