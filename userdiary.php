...
try {
   ...
   $stmt -> bindParam(':diarylabel', $diarylabel, PDO::PARAM_STR);      
                  ...
                  <li data-name=<?php echo '"userdiary'.$row[0].'"'; ?> data-inset="true" >  
                     ...
                     <div class="ui-grid-a">     
                        ...
                        <div  class="ui-block-b" style="font-weight:normal; width:100%; font-size:11px !important;">
                           <?php echo $row[2]; ?>
                           <input readonly="true" type="hidden" id=<?php echo '"userdiary'.$row[0].'_diarylabel"';?> value=<?php echo '"'.$row[2].'"'; ?> >
                           <input readonly="true" type="hidden" id=<?php echo '"userdiary'.$row[0].'_diarytxt"';?> value=<?php echo '"'.$row[3].'"'; ?> >
                        </div>
                     </div>
                    </a>
                  </li>                   
      ...
      <form id="register" action="userdiary_submit.php" method="get"  rel="external" data-ajax="false"> 
         <div data-role="fieldcontain">
           ...
           <fieldset data-role="controlgroup">
            ...
            <div data-role="fieldcontain">
              <label for="diarylabel">Label:</label>
              <div data-role="controlgroup">
               <input type="text" name="diarylabel" id="diarylabel" class="diarylabel" placeholder="Short label" data-mini="true" autofocus>
              </div>
            </div>
                  
            <div data-role="fieldcontain">
              <label for="diarytxt">Text:</label>
              <div data-role="controlgroup">
              <textarea cols="40" class="diarytxt" name="diarytxt" id="diarytxt" placeholder="Your diary entry" required> 
              </textarea>
              </div>
            </div>
